  ...
  <body>
    ...
    <script>
            ...
            data.forEach(student => {
              const row = `
                                <tr>
                                  ...
                                  <td>
                                    <button type="button" class="btn btn-success" title="Open Profile" onClick="openProfile(${student.id})">
                                    ...
                                    <button type="button" class="btn btn-primary" title="Update Profile" onClick="updateProfile(${student.id})">
                                    ...
                                    <button type="button" class="btn btn-danger" title="Remove Profile" onClick="removeStudent(${student.id})">
      ...
      function openProfile(id) {
        event.preventDefault(); // stop form reload
        window.location.href = "<%=request.getContextPath()%>/student-profile.jsp?id=" + id;
      }
      ...
      function removeStudent(id) {
        ...
        fetch("<%=request.getContextPath()%>/api/student?id=" + id, {
          ...
          .catch(error => {
            window.alert("Student delation failed!");
            console.log("Error:", error);
          });
      }
    </script>
