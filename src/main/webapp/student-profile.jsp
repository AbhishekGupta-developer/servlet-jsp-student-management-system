          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-2">
              <button type="submit" class="btn btn-primary"
                onclick='loadStudentProfile(document.getElementById("search-student-id").value)'>Search</button>
            </div>
          </div>
        </form>
            ...
            <div class="row mt-4">
              <div class="col text-center">
                <button class="btn btn-primary me-2"
                  onClick="updateProfile(Number(document.getElementById('student-info-student-id').textContent))">Update
                  Profile</button>
